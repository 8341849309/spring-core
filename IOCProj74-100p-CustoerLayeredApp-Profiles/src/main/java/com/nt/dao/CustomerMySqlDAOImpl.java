...
public class CustomerMySqlDAOImpl implements ICustomerDAO {
	...
	private static final String INSERT_CUST_DETAILS = "INSERT INTO customer(CUSTNAME,CUSTADDRS,BILLAMT) VALUES(?,?,?) ";

	@Autowired
	private DataSource ds;

	public CustomerMySqlDAOImpl() {
		System.out.println("CustomerMySqlDAOImpl.CustomerMySqlDAOImpl()");
	}
